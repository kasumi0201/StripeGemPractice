...
class CandiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candy" do
    assert_difference('Candy.count') do
      post candies_url, params: { candy: { description: @candy.description, image_data: @candy.image_data, name: @candy.name, price: @candy.price } }
    end
  ...
  test "should update candy" do
    patch candy_url(@candy), params: { candy: { description: @candy.description, image_data: @candy.image_data, name: @candy.name, price: @candy.price } }
